...
def train_parse_arguments():
    ...
    parser.add_argument('--basis_type', type=str, default='pos-norm',
                        choices=['pos-norm', 'pos-ori', 'neg-norm', 'neg-ori',
                                 'odd-sym', 'pos-larger', 'neg-larger'],
    ...
    parser.add_argument('--fit_mode', type=str, default='univariate',
                        choices=['line', 'spline', 'poly', 'univariate', 'fft'],
                        help='Basis-function fitting mode.')
    parser.add_argument('--model_type', type=str, default='tdkan',
                        choices=['tdkan', 'cnn'],
                        help='Model architecture: "tdkan" (fully-connected KAN) or "cnn" (CNN-KAN hybrid).')
    parser.add_argument('--td_basis_types', type=str, nargs='+', default=None,
                        help='Specific basis types to use, e.g. "Z21 Z15 ZAZ_21". '
                             'Overrides dataset defaults when search_mode is custom.')
