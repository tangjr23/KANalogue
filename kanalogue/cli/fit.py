#!/usr/bin/env python
"""
KANanlogue IV-curve fitting CLI.

Fit splines, polynomials, or univariate splines to raw tunnel-diode IV-curve CSVs.

Usage:
    kanalogue fit --mode univariate --input data/raw --output data/processed --smoothing 0.1
    kanalogue fit --batch --mode spline --input data/raw --output data/processed

    kanalogue fit --help   for all options.
"""
...
def make_argparser():
    ...
    p.add_argument("--input", type=str, default='data/raw',
